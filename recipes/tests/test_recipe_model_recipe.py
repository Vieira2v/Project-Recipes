...
class RecipeModelTest(RecipeTestBase):
    ...
    def make_recipe_no_defaults(self):
        ...
        recipe.full_clean()  # Aqui a validação ocorre.
        recipe.save()
        return recipe

    # Aqui estou criando 4 tipos de testes parameterizados.
    ...
    def test_recipe_fields_max_length(self, field, max_length):
        # Agora vou escrever um titulo q vai passar de 65 caracteres.
